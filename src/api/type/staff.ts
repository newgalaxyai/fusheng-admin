...
export type IStaffList = {
    ...
    idType: string // 证件类型 ID_CARD:身份证 PASSPORT:护照 MILITARY_ID:军官证 OTHER:其他
    idNumber: string // 证件号码
    hireDate: number[] // 入职时间
    createTime: number // 员工创建时间戳
    staffUpdateTime: number // 员工更新时间戳
    staffDeleteTime: number // 员工删除时间戳
    sex?: number // 员工性别 0:保密 1:男 2:女
    education?: number // 学历 DOCTOR:博士 MASTER:硕士 BACHELOR:本科 COLLEGE:专科 HIGH_SCHOOL:高中 OTHER：其他
    marriageStatus?: number // 婚姻状态 STAFF_MARRIAGE_STATUS
    email?: string // 邮箱
    remark?: string // 备注
    password?: string // 密码
}
